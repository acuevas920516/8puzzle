...
public class MainActivity extends AppCompatActivity {
    ...
    //A partir de aqui hemos agregado
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (gyroscope == null) {
            Toast.makeText(this, "El dispositivo no posee giroscopio", Toast.LENGTH_SHORT).show();
            finish();
        }
        ...
        gyroscopeEventListener = new SensorEventListener() {
            ...
            public void onSensorChanged(SensorEvent sensorEvent) {
                ...
                if (sensorEvent.values[1] > 2.0f) {
                    ...
                    {
                        if (tileList[i].equals("blank")){
                            position = i;
                        }
                    }
                    moveTiles(MainActivity.this,right,position);
                    ...
                    moveTiles(MainActivity.this,left,position);
                    ...
                    moveTiles(MainActivity.this,down,position);
                } else if (sensorEvent.values[0] < -2.0f) {
                    for(int i = 0; i< tileList.length; i++)
                    {
                        if (tileList[i].equals("blank")){
                    ...
                    moveTiles(MainActivity.this,up,position);
                }
            }
